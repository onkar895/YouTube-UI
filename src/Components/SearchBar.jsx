...
const SearchBar = ({ showSearch, setShowSearch }) => {
  ...
  const inputStyles = `${showSearch ? 'w-[61vw] max-sm:mx-auto transition-all duration-500 max-sm:ml-2 ml-2 pl-[12px] py-2' : 'max-sm:hidden'} ${isInputFocused ? 'max-sm:w-[74vw] max-sm:mx-auto max-sm:focus:outline-0 max-sm:border max-sm:border-blue-600 md:pl-[3.2rem] md:border md:border-blue-600' : ''} md:w-[36vw] lg:w-[42vw] md:py-[7px] lg:py-[7px] border border-gray-300 rounded-l-full py-1 pl-3 md:pl-6 items-center transition-all focus:outline-0 duration-500}`;
