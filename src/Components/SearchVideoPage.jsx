...
const SearchVideoPage = ({ info, videoId }) => {
  ...
  return (
    <div className='md:flex max-sm:flex-col cursor-pointer lg:w-[90vw] md:w-[84.2vw] max-sm:w-[100%] md:mx-auto max-sm:mx-auto md:gap-x-3' onMouseOver={() => setIsHovered(true)} onMouseOut={() => setIsHovered(false)}>
