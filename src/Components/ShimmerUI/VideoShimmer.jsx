...
const VideoShimmer = () => {
  return (
    <div className='md:flex md:flex-wrap max-sm:flex max-sm:flex-col md:gap-x-4 md:gap-y-16 max-sm:mx-3 max-sm:gap-y-12'>
      {
          ...
          .map((_, index) => (
            ...
            <NavLink key={index}>
              ...
              <div className='flex max-sm:ml-1 mt-[1rem] gap-2 items-center font-bold text-[14.6px] animate-pulse'>
                ...
                <div className='mr-2 bg-gray-300 h-12 lg:w-[24.5vw] md:w-[33vw] max-sm:w-[78vw] rounded-lg animate-pulse'></div>
              </div>
