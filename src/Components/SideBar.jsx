...
const SideBar = () => {
  ...
  return !isMenuOpen
    ...
    : (
      <>
        <div className='fixed shadow-2xl hover:overflow-y-scroll md:w-[32vw] lg:w-[19vw] h-full bg-white z-10 text-sm hover:overflow-x-hidden top-[55px] transition-shadow duration-300'>
