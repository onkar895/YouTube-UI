...
const Error = () => {
  ...
  const classNameString = !isMenuOpen
    ...
    : `bg-black font-bold text-justify tracking-wide rounded-2xl text-white box-border w-[52%] py-6 px-8 ml-[32%] min-h-[20vh] relative  `;

  return (
    <>
      <h1 className={`w-[100%] gap-2 overflow-hidden mt-24 lg:mx-60 max-sm:mx-5 text-red-500 font-bold text-3xl`}>Unable to fetch the request for now ! 🙄</h1>
      <div
        className={`w-[100%] ${classNameString} flex flex-col gap-2 justify-between overflow-hidden mt-5`}
      >
